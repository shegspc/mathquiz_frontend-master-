...
const End = () => {
  ...
  const handleSave = async (e) => {
   ...
   try{
      ...
      await axios.post("https://mymathquizapi.onrender.com/backend/multiplicationResult/postResult", newPost);
      setSaved(true)
 ...
 const { data } = useFetch(`https://mymathquizapi.onrender.com/backend/multiplicationResult/getResults/${userId}`);
